...
# 2. 상단 전체 폭: 1. 기업 개요 및 주요 수익원 (3줄 요약 형태로 길게 배치)
...
# 3. 하단 분할: 좌측(2번 기술적 조건 검증 + 4번 최근 주요 뉴스), 우측(3번 재무/밸류에이션 차트)
col_left, col_right = st.columns([5, 5], gap="medium")

with col_left:
    # 2. 기술적 조건 검증 (한 줄에 다 보이도록 구성)
